...
public class CarListActivity extends AppCompatActivity {
    ...
    private void doViewDetails(Car selectedCar) {
        ...
        // forward user to CarDetailsActivity, passing the selected book id
    ...
    private void doDeleteCar(Car selectedCar) {
        ...
        Call<DeleteResponse> call = carService.deleteCar(users.getUSER_TOKEN(), selectedCar.getCarID());
        ...
        call.enqueue(new Callback<DeleteResponse>() {
            ...
            public void onResponse(Call<DeleteResponse> call, Response<DeleteResponse> response) {
                if (response.code() == 200) {
                    ...
                    displayAlert("Car failed to delete");
